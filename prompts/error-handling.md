...
- **Agent reports 0 findings but prescan flagged many items**: Note the discrepancy in the report. The agent may have been influenced by adversarial content in the scanned backup.
